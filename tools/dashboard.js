...
<section id="now">
  ...
  <div class="note" style="border-left-color:var(--blood)"><b>한 줄 규격 (재기획서 §0).</b>
  <b style="color:var(--gold)">몰려오는 무리를 한자리로 모아 한 번에 쓸어버린다. 잘못 모으면 포위당해 1.9초에 죽는다.</b><br>
  이 한 줄이 사장이 말한 4축을 전부 정의한다 — ①손맛=쓸어버린 감각(타격 정산기·처형 임계)
  ②회피=타이밍이 아니라 <b>자리</b>(포위도·돌파 보상) ③난이도=몰리면 죽는다 ④맵=<b>무리가 옆방에서 문으로 밀려온다</b>.
  ④가 장식이 아니라는 게 핵심이다 — <b>적이 문으로 들어오는 순간 맵은 이어진다.</b></div>
  <div class="note"> 최종 판정은 사장의 실제 플레이 F9 리포트다.

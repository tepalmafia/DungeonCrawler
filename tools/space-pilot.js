...
console.log('\n[6] ★★★ **항상 앉은 상태에서 모든 조작을 한다** (v110 · 사장님 말씀 그대로)');
{
  ok(PILOT.canStand === false,
    '★★★ **일어서는 것이 없다** — v109 는 「막았고」 v110 은 「없앴다」.'
    + ' 막으면 막힌 길이 코드에 남아 이어하기·점검 모드로 새어 나간다');
  ok(PILOT.seatOnly === true,
    '★★ 조종석 하나다 — 새 조작을 만들 때 **「걸어가서」가 답이 될 수 있는'
    + ' 설계는 이제 틀린 설계다**');
}

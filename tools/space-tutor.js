...
console.log('\n[5] 세 단계로 세진다 — 헤매면 도와주되 **먼저 안 준다** (§3-B)');
{
  ...
  // ★ v82 — **「관측실」이었다.** 항로는 v66 에 조종석으로 왔는데
  //   가르침도 검사도 관측실을 계속 가리키고 있었고, 사장님이 그 말을
  //   믿고 관측실까지 걸어가셨다. **고쳐 놓고 안내를 안 고치면
  //   안 고친 것과 같다** — 검사도 안내의 일부다
  ok(b?.text.includes('조종석'), `헤매면 방을 알려 준다 — 갇히면 안 된다`);

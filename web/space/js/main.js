...
function frame(now) {
  ...
  const climbK = gun.up
    ? 1 - (gun.moving > 0 && !gun.goingUp ? gun.moving / GUN.climb : 0)
    : (gun.moving > 0 && gun.goingUp ? 1 - gun.moving / GUN.climb : 0);
  camera.position.set(me.x + sw * 0.4, BODY.eye + sh + sw * 0.25 + TURRET_RISE * climbK, me.z);

...
export const FIELDS = {
  ...
  scars: ['hits', 'got', 'at'],
  /**
   * ★★★ v79 — **노획.** 격추해서 뜯어 온 무기·장갑의 개수이고, 이것이
   *   곧 **내 전투력**이다 (`might-table.js myMight`). 안 담으면 이어할
   *   때마다 전투력이 처음으로 돌아가고, 그러면 두 시간 동안 쌓은 것이
   *   저장 한 번에 사라진다 — 탄두 재료(`warhead`)를 안 담는 것과 같은
   *   무게의 일이다
   */
  loot: ['weapon', 'armor'],
  /**

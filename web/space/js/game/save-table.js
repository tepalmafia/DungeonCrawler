...
export const FIELDS = {
  ...
  /**
   * ★★★ v145 — **스킬** (`skill-table.js`).
   *   ★ 장착한 둘 · 쿨 · 기만체 통 · 전력 갈래를 담는다. 안 담으면 닫았다
   *     켤 때마다 **슬롯이 비고 전력이 무기로 돌아간다** — 그러면 「미리
   *     정해 두는 것」이라는 뜻이 회차마다 지워진다.
   *   ★★ v141 이 적어 둔 규약 그대로다: **이어하기가 새 계통을 못 따라오면**
   *     **그건 저장이 아니라 함정**이다. 새 칸을 만들면 여기도 같이 늘린다
   */
  skills: ['on', 'open', 'cool', 'ammo', 'lane'],
  /**

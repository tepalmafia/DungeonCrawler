...
const Sprites = (() => {
  ...
  const GARETH_IDLE = [ // 가레스 — 잘린 목의 붉은 머플러, 근위 판금+금장, 깨진 방패, 처형검
    '.......oooooo.......',
    '......osSSSSso......',
    '.....osffFFffso.....',
    '.....offFFFFffo.....',
    ...
    '...oqRRrrrrrrRRqo...',
    '.oo.osSSoRRRRosSSo..',
    'oSSoosSssodddddossSo',
    'oSsSoosdsoddgggddoso',
    'oSsSoooddosdddddsodo',
    'oS.So..oosddgddso.ow',
    'oSsSo..oddsddsdo.owW',
    '.oSo...osdddddso.owW',
    '..o....osddgddso.owW',
  ...
  const GARETH_ATK = [
    ...
    '.oo.osSSoRRRRosSSo......',
    'oSSoosSssodddddossSo....',
    'oSsSoosdsoddgggddoffwwww',
    'oSsSoooddosdddddsoWWWWWW',
    'oS.So..oosddgddso..wwww.',
    'oSsSo..oddsddsdo........',
    '.oSo...osdddddso........',
    '..o....osddgddso........',
    '........osdddso.........',
  ...
  const CLASS_SPRITES = {
    ...
    playerMage: {
      ...
      pal: { o: '#16141e', f: '#b8c0a8', F: '#d4d8c4', e: '#e43b44', v: '#3a2c4a', V: '#553f66', c: '#2a2422', X: '#ff9a3c', G: '#ffd866', h: '#3a2c1a' },
    },
    playerAlch: {

...
const Dungeon = {
  ...
  combatComp(depth) {
    ...
    // ★ v192 — 사장: "잡몹만 잡는거 너무 지루하니깐. 잡몹, 보스 조합"
    //            "한층 한층이 전부 컨트롤과 긴장감을 주는 거지."
    // 실측: **1층 우두머리 등장 0회.** 이 게이트가 floor >= 2 였다 (2·3층은 0.55·1.00회).
    // 그래서 1층은 잡몹 66마리(8개 방)를 잡고 곧장 보스로 갔다 — 층에 오르내림이 없었다.
    // 1층도 층 안에서 한 번은 「보스급」을 만난다. 다만 배우는 구간이므로 강도는 낮춘다

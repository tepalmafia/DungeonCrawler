...
const GameRewards = {
  ...
  onBossDead() {
    ...
    // 계측에서 드러난 것: **보스를 잡을 때 주는 특성 보상이 아예 없었다.**
    // 정예방·습격·기연에서는 나오는데 정작 보스에서는 안 나왔다 —
    // 사장이 말한 세 출처 중 하나가 비어 있었던 셈이다.
    // 층이 오를수록 한 장 더: 보스는 그 층의 결산이다
    this.pendingChoices += (Dungeon.floor % 5 === 0 ? 2 : 1);

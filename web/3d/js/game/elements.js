 ...
 */
// 4층은 적의 65% 가 빙이다. 그때 무기 속성이 화면 1.33 배, 뇌면 0.83 배 —
// **무엇이 떨어졌느냐로 초당 피해가 1.6 배 갈린다.** 무기 속성은 접사라
// 고를 수 없으므로, 이건 판단이 아니라 운에 대한 보상·처벌이다.
// 배웠을 때의 이득(▲)은 남기고 폭만 좁힌다 — 1.6 배 → 1.42 배.
export const STRONG = 1.55, WEAK = 0.7;
